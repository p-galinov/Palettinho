  ...
  class NewPaletteForm extends Component {
    ...
    componentDidMount() {
      ...
      removeColor = colorName => {
        const newChosen = this.state.colors.filter(color => color.name !== colorName)
        this.setState({colors: newChosen })
      }
      ...
      savePalette(newPalette){
        ...
        this.props.history.push("/"); //back to the home page
      }
            ...
            >
                ...
                <div className={classes.container}>
                  ...
                  <div className={classes.buttons}>
                    ...
                    <Button variant="contained" color="primary" disabled={paletteFull} onClick={this.addRandomColor} className={classes.button}>Random</Button>
                  </div>
